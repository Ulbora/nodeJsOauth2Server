...
describe('TokenManager', function () {
    ...
    describe('#authCodeToken()', function () {
        it('should get token in tokenmanager a second time an get invalid_client', function (done) {
            setTimeout(function () {
                db.getClient(clientId, function (clientResult) {
                    if (clientResult && clientResult.secret) {
                        var secret = clientResult.secret;
    ...
    describe('#authCodeToken()', function () {
        it('should get token in tokenmanager a third time an get invalid_client', function (done) {
            setTimeout(function () {
                db.getClient(clientId, function (clientResult) {
                    if (clientResult && clientResult.secret) {
                        var secret = clientResult.secret;
