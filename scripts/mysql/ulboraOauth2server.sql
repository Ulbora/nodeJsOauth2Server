...
-- Sat 04 Feb 2017 04:25:28 PM EST
...
CREATE TABLE IF NOT EXISTS `ulbora_oauth2_server`.`authorization_code` (
  ...
  `randon_auth_code` VARCHAR(30) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ulbora_oauth2_server`.`auth_code_revolk`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ulbora_oauth2_server`.`auth_code_revolk` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `authorization_code` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
